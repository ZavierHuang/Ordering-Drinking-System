...
public class LatteServlet extends HttpServlet {
    private static final String CUSTOMER_URL = "WEB-INF/jsp/products/Latte.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Product> latte = productService.getProductsByType("Latte");
        String latteJson = new Gson().toJson(latte);
        //System.out.println("latteJson:"+latteJson);
