...
<div id="wrapper">
    ...
    <footer id="footer">
        <div id="wrapper3">
            ...
            <span>
                <span id="amount2" style="display: none;">${ordersSum}</span>
        ...
        <div id="wrapper2">
            <h1>All EMPLOYEE</h1>
            <div class="block">
                <span id="allEmpJson" style="display: none;">${allEmpJson}</span>
                <table id="allEmpTable">
                </table>
            </div>

            <span>
                <span id="amount" style="display: none;">${empSum}</span>
                <h3 style="font-size: 150%;">Total: ${empSum}</h3>
                <button style="font-size: 25px" onclick="send()">確定</button>
            </span>
        </div>
